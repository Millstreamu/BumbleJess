...
const Enclosure := preload("res://scripts/world/Enclosure.gd")
const Growth := preload("res://scripts/world/Growth.gd")
const Mutation := preload("res://scripts/world/Mutation.gd")
const ResourcesSystem := preload("res://scripts/world/Resources.gd")
...
const TurnController := preload("res://scripts/world/TurnController.gd")
const ReviewBanner := preload("res://scripts/ui/ReviewBanner.gd")
