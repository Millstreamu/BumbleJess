...
const Hex := preload("res://scripts/world/core/Hex.gd")
const InputMapConfig := preload("res://scripts/world/core/InputMap.gd")
const CursorScene := preload("res://scenes/world/Cursor.tscn")
