...
func add_tile(axial: Vector2i, category: String, variant_id: String, fx: String = "") -> void:
                placed_tiles[key(axial)] = {
                                "category": category,
                                "variant_id": variant_id,
                                "flags": {},
                }
                _render_tile(axial, category, variant_id, fx)

func replace_tile(axial: Vector2i, category: String, variant_id: String, fx: String = "") -> void:
                placed_tiles[key(axial)] = {
                                "category": category,
                                "variant_id": variant_id,
                                "flags": {},
...
func add_decay(axial: Vector2i, fx: String = "") -> void:
                add_tile(axial, "Decay", "decay_base", fx)
...
func _render_tile(_axial: Vector2i, _category: String, _variant_id: String, _fx: String = "") -> void:
